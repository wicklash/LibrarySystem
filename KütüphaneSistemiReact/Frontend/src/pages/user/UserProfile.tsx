    ...
    <UserLayout title="Profile">
      ...
      {success && (
        <div className="fixed top-8 left-1/2 transform -translate-x-1/2 z-50 animate-fade-in">
          <div className="bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg font-semibold text-lg">
      ...
      {!userInfo ? (
        <div className="flex items-center justify-center min-h-[60vh] animate-fade-in">
          <div className="flex flex-col items-center">
            ...
            <span className="text-lg text-slate-600">Yükleniyor...</span>
          </div>
        </div>
      ) : (
        <div className="animate-fade-in bg-slate-100 min-h-screen py-8 px-2">
          {/* Üst Kart */}
